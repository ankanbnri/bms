					...
					<c:when test="${busFound}">
						...
						<section class="container result-page">
							...
							<div class="row">
								...
								<span class="font-weight-bold busFound">&nbsp;${buses.get(0).getRoute().getStartName()}
								</span>
								<span>&nbsp;to</span>
								<span class="font-weight-bold busFound">&nbsp;${buses.get(0).getRoute().getStopName()}
								</span>
								<span>&nbsp;on</span>
					...
					<c:otherwise>
						<section class="container">
							<div class="row no-bus-found-parent justify-content-lg-center justify-content-md-center">
								<div class="card">
									<div class="card-body">
										No bus found in this Route. Kindly select a different route and plan your
										journey accordingly.
									</div>
								</div>
							</div>
						...
						<div class="container">
							<div class="row py-4 d-flex align-items-center justify-content-center">
								<div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
									Copyright <i class="fa fa-copyright" aria-hidden="true"></i> Bus
