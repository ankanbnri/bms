        ...
        <div class="container">
            <form class="search-form" method="post">
                <div class="input-group mb-3 my-auto search-element">
                    ...
                    <%-- <input type="text" class="form-control" placeholder="Source" aria-describedby="basic-addon1" name="source"> --%>
                    <select class="form-select form-control" aria-label="Default select example" name="source" required>
                ...
                <div class="input-group mb-3 my-auto search-element">
                    ...
                    <%-- <input type="text" class="form-control" placeholder="Destination" aria-describedby="basic-addon1" name="destination"> --%>
                    <select class="form-select form-control" aria-label="Default select example" name="destination" required>
                ...
                <div class="input-group mb-3 my-auto search-element">
                    ...
                    <input type="date" id="travelDate" class="form-control" placeholder="Date" aria-describedby="basic-addon1" name="travelDate" required>
                </div>
