                        ...
                        <div class="container">
                            <form class="search-form" method="post">
                                ...
                                <div class="input-group mb-3 my-auto search-element">
                                    ...
                                    <input type="date" id="travelDate" class="form-control" placeholder="Date"
                                        aria-describedby="basic-addon1" name="travelDate" required>
                                </div>
                                ...
                                <div class="card-deck">
                                    <div class="card col-lg-4 col-sm-6 col-md-6 text-center text-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">With Safety+ we have brought in a set of measures like
                                                Sanitized buses,
                                    ...
                                    <div class="card col-lg-4 col-sm-6 col-md-6 text-center text-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">We put our experience and relationships to good use and
                                                are available
                                    ...
                                    <div class="card col-lg-4 col-sm-6 col-md-6 text-center text-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">We always give you the lowest price with the best
                                                partner offers.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row py-4 d-flex align-items-center justify-content-center">
                                    <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                                        Copyright <i class="fa fa-copyright" aria-hidden="true"></i> Bus Management
                                        System 2022
                                    </div>
                                </div>
                            </div>
