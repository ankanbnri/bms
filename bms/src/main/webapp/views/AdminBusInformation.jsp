    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Displaying All Bus Information</li>
            </ol>
                ...
                <div class="card-body">
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <p class="fw-bold mb-1">WBAC1234</p>
                                    <p class="text-muted mb-0 small">NON-AC</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">BUS1</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">Kolkata</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">Delhi</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">50</p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href=""><span class="fas fa-edit pr-2"></span></a>
                                    <a href=""><span class="fas fa-ban"></span></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p class="fw-bold mb-1">WBAC1274</p>
                                    <p class="text-muted mb-0 small">NON-AC</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">BUS1</p>
                            ...
                            <tr>
                                <td>
                                    <p class="fw-bold mb-1">WBAC1254</p>
                                    <p class="text-muted mb-0 small">NON-AC</p>
                                </td>
                                <td>
                                    <p class="fw-bold mb-1">BUS1</p>
